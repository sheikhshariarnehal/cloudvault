        ...
        >
          ...
          >
            <Folder
              ...
              fillOpacity={0.22}
            />
            <span className="text-[11px] sm:text-[13px] font-medium text-[#202124] truncate">
              {folder.name}
            </span>
          </Link>

          <div className="sm:opacity-0 sm:group-hover:opacity-100 transition-opacity duration-150">
